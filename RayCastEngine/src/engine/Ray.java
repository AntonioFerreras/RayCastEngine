...
public class Ray {
	...
	static Point2D.Double getPointHorTall(Graphics2D g2d, double rx, double ry, double rdir) {
		//Convert rdir to standard rotation angle
		if(rdir < 0)
			rdir = 360+rdir;
		else if (rdir > 360) 
	...
	static Point2D.Double getPointVertTall(Graphics2D g2d, double rx, double ry, double rdir) {
		//Convert rdir to standard rotation angle
		if(rdir < 0)
			rdir = 360+rdir;
		else if (rdir > 360) 
